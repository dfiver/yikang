...
export default class CommitProductInfo extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            workshop: {
                selected: '002',
                selectURL: '/data/workshop/options',
                items: [{
                    key: '001',
                    value: '生产车间1'
                }, {
            ...
            productFamily: {
                selected: '002',
                selectURL: '/data/productfamily/options',
                items: [{
                    key: '001',
                    value: '产品家族1'
                }, {
            ...
            productType: {
                selected: '002',
                selectURL: '/data/productcode/options',
                items: [{
                    key: '001',
                    value: '2001'
                }, {
            ...
            batchNo: {
                selected: '002',
                selectURL: '/data/batchno/options',
                items: [{
                    key: '001',
                    value: '01'
                }, {
